...
export class RootMigrations1726285688280 implements MigrationInterface {
    name = 'RootMigrations1726285688280'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`warehouses\` (\`id\` int NOT NULL AUTO_INCREMENT, \`TenKho\` varchar(255) NOT NULL, \`DiaChi\` varchar(255) NOT NULL, \`TungDo\` int NULL, \`HoanhDo\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
